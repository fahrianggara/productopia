...
<body>
    ...
    <main id="main">
        <section id="welcome">
            <div class="container">
                <div class="row flex-row-reverse align-items-center">
                    <div class="welcome-banner col-xl-6 col-lg-6 col-md-6">
                        <picture class="welcome-banner-inner">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="welcome-text">
                            ...
                            <p>
                                Productopia adalah sebuah website yang menyediakan berbagai macam produk yang dapat
                                dibeli secara online.
                            </p>
                            <a href="#elektronik" class="btn welcome-btn">Lihat Produk</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-bg" id="elektronik">
            <div class="container">
                <div class="section-title">
                    <h2>Elektronik</h2>
                    <p>
                        Produk elektronik yang tersedia di Productopia, mulai dari headphone, smartphone, dan laptop.
                        Dapatkan produk elektronik terbaik hanya di Productopia.
                    </p>
                </div>
                ...
                <div class="product-container">
                    <ul class="product-list">
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    ...
                                    <img
                                        src="https://images.tokopedia.net/img/cache/200-square/VqbcmM/2023/3/7/f06992e7-2e18-4965-a808-a735f1c4ddbb.jpg">
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <span class="product-tag bg-primary">New</span>
                                    <img
                                        src="https://images.tokopedia.net/img/cache/200-square/VqbcmM/2022/11/17/8d6ebd18-1f84-4e23-a243-ef6ab7dfacb5.jpg">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <span class="product-tag bg-danger">Hot</span>
                                    <img
                                        src="https://images.tokopedia.net/img/cache/200-square/VqbcmM/2023/4/19/d76524de-9267-4d3c-ad1d-366f079742f0.jpg">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <!-- <span class="product-tag bg-danger">Hot</span> -->
                                    <img
                                        src="https://images.tokopedia.net/img/cache/200-square/VqbcmM/2022/6/21/18094306-8154-4652-b22a-cd75f1f4f1f4.png">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <span class="product-tag bg-danger">Hot</span>
                                    <img
                                        src="https://images.tokopedia.net/img/cache/200-square/VqbcmM/2021/10/1/194b570c-b7f1-41d2-995a-89f62a13a7c9.jpg">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <span class="product-tag bg-danger">Hot</span>
                                    <img
                                        src="https://images.tokopedia.net/img/cache/900/VqbcmM/2023/3/17/598a51f7-4def-47b9-94bf-e61439bf875d.jpg">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
        ...
        <section>
            <div class="container">
                <div class="section-title">
                    <h2>Fashion</h2>
                    <p>
                        Produk fashion yang tersedia di Productopia, mulai dari pakaian, sepatu, dan aksesoris. Dapatkan
                        produk fashion terbaik hanya di Productopia.
                    </p>
                </div>
                        ...
                        <li class="product-item">
                            <div class="product">
                                <div class="product-image">
                                    <span class="product-tag bg-danger">Hot</span>
                                    <img
                                        src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/h/t/ht9443_2_apparel_photography_front20center20view_grey.jpg">
                                    <ul class="product-action">
                                        <li><a href="javascript:void(0)"><i class="fas fa-external-link-alt"></i></a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="fas fa-shopping-cart"></i></a></li>
...
>>>>>>> ea556ef26791822b57025dd283bb42e15012628e:backup-index.php
            <div class="container">
                <div class="section-title h2" id="tentang kami">
                    <h2>Our Team</h2>
                </div>
